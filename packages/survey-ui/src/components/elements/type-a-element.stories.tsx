...
import { TypeAElement, type TypeAElementProps } from "./type-a-element";

type StoryProps = TypeAElementProps &
  Partial<BaseStylingOptions & InputLayoutStylingOptions> &
  Record<string, unknown>;

const meta: Meta<StoryProps> = {
  title: "UI-package/Elements/TypeAElement",
  component: TypeAElement,
  parameters: {
    layout: "centered",
    docs: {
      description: {
        component: "A TypeA survey element that collects text input from respondents.",
      },
    },
  },
  tags: ["autodocs"],
  ...
  render: createStatefulRender(TypeAElement),
};
...
export const StylingPlayground: Story = {
  args: {
    elementId: "type-a-1",
    inputId: "type-a-input-1",
    headline: "TypeA Element Question",
...
export const RTL: Story = {
  args: {
    elementId: "type-a-rtl",
    inputId: "type-a-input-rtl",
