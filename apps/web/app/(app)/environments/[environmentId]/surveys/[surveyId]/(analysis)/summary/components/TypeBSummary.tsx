...
import { TSurvey, TSurveyElementSummaryTypeB } from "@formbricks/types/surveys/types";
...
interface TypeBSummaryProps {
  elementSummary: TSurveyElementSummaryTypeB;
  environmentId: string;
  survey: TSurvey;
  locale: TUserLocale;
}

export const TypeBSummary = ({ elementSummary, environmentId, survey, locale }: TypeBSummaryProps) => {
