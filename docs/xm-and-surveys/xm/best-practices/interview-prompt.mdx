...
* Integrate directly with Cal.com using the [Schedule a Meeting](/xm-and-surveys/surveys/question-type/schedule-a-meeting) question type for seamless scheduling.
...
<Note>
  Formbricks SDK running? We assume that you have already installed the Formbricks SDK in your web app. It’s required to display messages and surveys in your app. If not, please follow the [Quick Start Guide (15mins)](/xm-and-surveys/surveys/website-app-surveys/quickstart)
</Note>
...
In the button settings you have to make sure it is set to “External URL”. In the URL field, copy your booking link (e.g. `https://cal.com/your-company/user-interview`). If you don’t have a booking link yet, head over to [cal.com](https://cal.com) and get one - they have the best free plan out there!
...
<Note>
  Formbricks SDK running? You need to have the Formbricks SDK installed to display the Interview Prompt in your app. Please follow [this tutorial (Step 4 onwards)](/xm-and-surveys/surveys/website-app-surveys/quickstart) to install the SDK.
</Note>