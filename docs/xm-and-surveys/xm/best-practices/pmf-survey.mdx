...
<Note>
  Formbricks SDK running? You need to have the Formbricks SDK installed to display the PMF Survey in your app. Please follow [this tutorial (Step 4 onwards)](/xm-and-surveys/surveys/website-app-surveys/quickstart) to install the widget.
</Note>
