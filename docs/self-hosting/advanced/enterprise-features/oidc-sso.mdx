...
For detailed configuration instructions for all supported SSO providers (OpenID Connect, Azure AD OAuth, Google OAuth, and SAML), see the [Auth SSO Configuration Guide](/self-hosting/configuration/auth-sso/open-id-connect).
