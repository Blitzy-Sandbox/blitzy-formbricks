...
| ------------------- | -------------------------------------------------------- | ----------- |
| `sliderDirection`   | Direction the panel slides in from — `"left"` or `"right"` | `"right"`   |
| `sliderWidth`       | Width of the slider panel                                | `"400px"`   |
| `animationDuration` | Duration of the slide animation in milliseconds          | `300`       |
...
| Option           | Description                                                                                      | Default          |
| ---------------- | ------------------------------------------------------------------------------------------------ | ---------------- |
| `buttonPosition` | Position of the floating button — `"bottom-right"`, `"bottom-left"`, `"top-right"`, or `"top-left"` | `"bottom-right"` |
| `buttonColor`    | Background color of the floating button                                                          | `"#000000"`      |
| `formWidth`      | Width of the expanded survey form                                                                | `"400px"`        |
| `formHeight`     | Height of the expanded survey form                                                               | `"500px"`        |
...
| Option        | Description                                                  | Default      |
| ------------- | ------------------------------------------------------------ | ------------ |
| `tabLabel`    | Text displayed on the vertical tab                           | `"Feedback"` |
| `tabPosition` | Which edge the tab is anchored to — `"left"` or `"right"`   | `"right"`    |
| `tabColor`    | Background color of the tab                                  | `"#000000"`  |
