...
<Note>
  An Enterprise License is required to access features such as SSO (SAML & OIDC), audit logging, team access
  control, multi-language surveys, and contact management with segments. See the
  [License](/self-hosting/advanced/license) page for a full feature comparison between the Community Edition
