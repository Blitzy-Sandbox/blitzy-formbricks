...
### 6. You’re Ready To Publish Your Survey!

![Publish survey](/images/xm-and-surveys/xm/best-practices/feedback-box/publish-survey.webp)

## Setting Up The SDK

<Note>Formbricks SDK running? You need to have the Formbricks SDK installed to display the Feedback Box in your app. Please follow [this tutorial (Step 4 onwards)](/xm-and-surveys/surveys/website-app-surveys/quickstart) to install the SDK.</Note>