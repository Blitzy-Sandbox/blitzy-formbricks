...
<Note>
  Contact management and segments are enterprise features that require an active enterprise license. Learn more about [Enterprise Features](/self-hosting/advanced/enterprise-features/contact-management-segments).
</Note>
